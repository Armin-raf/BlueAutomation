...
const HYPERSPEED_OPTIONS = {
  ...
  "colors": {
    ...
    "background": 0x000000,
    "shoulderLines": 0x00f7ff,
    "brokenLines": 0x00f7ff,
    "leftCars": [0x00f7ff, 0x0066ff, 0x00ff99],
    "rightCars": [0xff00e1, 0x9d00ff, 0xff0055],
    "sticks": 0x00f7ff
  }
};
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-10 flex flex-col gap-8">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 backdrop-blur-2xl border border-white/10 text-blue-300 w-fit mx-auto lg:mx-0">
              ...
              <span className="text-xs font-bold uppercase tracking-widest">Enterprise-Grade AI Automation</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.05] text-white text-glow">
              Automatisieren Sie Ihre komplexesten <br />
              <span className="text-primary">Workflows mit KI-Agenten.</span>
            </h1>
            
            <p className="text-xl text-blue-100/90 leading-relaxed max-w-3xl mx-auto lg:mx-0">
              Steigern Sie Ihre operative Effizienz, eliminieren Sie manuelle Fehler und skalieren Sie Ihr Business – ohne zusätzliches Personal. Wir integrieren maßgeschneiderte KI-Agenten tief in Ihre bestehenden Systeme.
            </p>
